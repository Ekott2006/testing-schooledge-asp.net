...
public static class FileHelper
{
    ...
    public static readonly string[] FileImageExtensions = [".jpg", ".png", ".pdf", ".txt"];
    public static readonly string[] FileDocExtensions = [".csv", ".xlsx"];
    public const string FileImageUpload = "images";
    public const string FileDocUpload = "doc";

    // Upload file with validation
    public static async Task<(bool Success, string Message, string? FilePath)>  UploadFileAsync(IFormFile? file,
        string uploadPath, IEnumerable<string> allowedExtensions, long maxFileSize = 5 * 1024 * 1024)
    {
